function [DilatationData_NoOutliers] = PlotDilatation2D(FaultTriangles,...
    FaultPoints,X_Obs,Y_Obs,Z_Obs,Exx,Eyy,Ezz,X_cont,Y_cont,FaultFileString)
...
hold on
scatter3(DilatationData(:,1),DilatationData(:,2),DilatationData(:,3),1,DilatationData_NoOutliers, 'filled')
