function [PercentTnChange] = PlotTnChange(FaultTriangles,FaultPoints,...
    X_Obs,Y_Obs,Z_Obs,Tn_Change,Tn_In,FaultFileString)
...
hold on
scatter3(TnchangeData(:,1),TnchangeData(:,2),TnchangeData(:,3),10,PercentTnChange, 'filled') 
hold on
