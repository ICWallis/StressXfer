function [AllSum] = PlotAllNormalized2D(FaultTriangles,FaultPoints,...
    X_Obs,Y_Obs,Z_Obs,Ts_Change,Ts_In,Tn_Change,Tn_In,CSS_Change,CSS_In ...
    ,Exx,Eyy,Ezz,X_cont,Y_cont,FaultFileString)
...
scatter3(TschangeData(:,1),TschangeData(:,2),TschangeData(:,3),1,AllSum, 'filled')
hold on
