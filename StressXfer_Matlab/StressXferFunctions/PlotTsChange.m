function [PercentTsChange] = PlotTsChange(FaultTriangles,FaultPoints,...
    X_Obs,Y_Obs,Z_Obs,Ts_Change,Ts_In,FaultFileString)
...
scatter3(TschangeData(:,1),TschangeData(:,2),TschangeData(:,3),10,PercentTsChange, 'filled')
hold on
