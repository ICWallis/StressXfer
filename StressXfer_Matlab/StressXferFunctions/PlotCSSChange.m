function [PercentCssChange] = PlotCSSChange(FaultTriangles,FaultPoints,...
    X_Obs,Y_Obs,Z_Obs,CSS_Change,CSS_In,FaultFileString)
...
scatter3(CSSChangeData(:,1),CSSChangeData(:,2),CSSChangeData(:,3),10,PercentCssChange, 'filled') 
