...
Sz1= S3;    %Magnitude of component 1
Sz2= S1;	%Magnitude of component 2
%Vertical stress mag
Sz3= S2; 	%Magnitude of component 3

%% DefineDirection
Dir1=DirS1; 	%direction (az) of component 1 (degrees)
Dir2=Dir1+90; 	%direction (az) of component 2 (degrees)
...
%     assignin('base','Sxx',CartSxx);
%     assignin('base','Syy',CartSyy);
%     assignin('base','Szz',CartSzz);
%     assignin('base','Sxy',CartSxy);
%     assignin('base','Sxz',CartSxz);
%     assignin('base','Syz',CartSyz);
%     
%     assignin('base','CartSxx',CartSxx);
%     assignin('base','CartSyy',CartSyy);
%     assignin('base','CartSzz',CartSzz);
%     assignin('base','CartSxy',CartSxy);
%     assignin('base','CartSxz',CartSxz);
%     assignin('base','CartSyz',CartSyz);
% 
% if nargout==0
