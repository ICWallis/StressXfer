function [S1In,S2In,S3In,S1dirIn,S2dirIn,S3dirIn,S1Out,S2Out,S3Out,S1dirOut,S2dirOut,S3dirOut,S1,S2,S3,S1dir,S2dir,S3dir] = PlotOutputStresses2D(Sxx_Obs_Out,Syy_Obs_Out,Szz_Obs_Out,...
    Sxy_Obs_Out,Sxz_Obs_Out,Syz_Obs_Out,Sxx_Obs_In,Syy_Obs_In,Szz_Obs_In,...
    Sxy_Obs_In,Sxz_Obs_In,Syz_Obs_In,X_Obs, Y_Obs, Z_Obs,FaultPoints,FaultTriangles,X_cont,Y_cont,FaultFileString)
...
hold on
scatter3(X_Obs(:),Y_Obs(:),Z_Obs(:),1,Sdiff_pchange(:) ,'filled') 
hold on
