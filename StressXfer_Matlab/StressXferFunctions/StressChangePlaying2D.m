...
[S1In,S2In,S3In,S1dirIn,S2dirIn,S3dirIn,S1Out,S2Out,S3Out,S1dirOut,S2dirOut,S3dirOut,S1,S2,S3,S1dir,S2dir,S3dir] = PlotOutputStresses2D(Sxx_Obs_Out,Syy_Obs_Out,Szz_Obs_Out,...
    ...
    FaultTriangles,X_cont,Y_cont,FaultFileString);
